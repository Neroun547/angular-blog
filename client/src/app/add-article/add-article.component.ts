...
export class AddArticleComponent implements OnInit {
  ...
  contentValidator(control: FormControl): null | object {
  ...
  titleValidator(control: FormControl): null | object {
  ...
  themeValidator(control: FormControl): null | object {
    if (control.value?.length > 30 || control.value?.length < 1){
      return {'theme': true};
    } else {
      return null;
  ...
  avtorValidator(control: FormControl): null | object {
