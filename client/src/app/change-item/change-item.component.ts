...
export class ChangeItemComponent implements OnInit {
  ...
  constructor(
    private acountSettingsService: AccountSettingsService,
  ...
  submitForm(): void {
    ...
    if (this.paramUrl === 'password'){
      this.acountSettingsService
      .changeParam({newparam: this.changeUserNameForm.value.newparam,
